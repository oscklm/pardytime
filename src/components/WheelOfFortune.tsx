...
import { BlurMask, Canvas, Path, Skia, vec } from "@shopify/react-native-skia";
  ...
  const spin = () => {
    ...
    setTimeout(() => {
      ...
      rotation.value = withTiming(
        ...
        (finished) => {
          if (finished) {
            // Phase 2: Fallback to final target
            rotation.value = withTiming(
              finalRotation,
              {
                duration: 500,
  ...
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      ...
      <View style={{ marginTop: 20 }}>
        <Button size="lg" onPress={spin} disabled={isSpinning}>
